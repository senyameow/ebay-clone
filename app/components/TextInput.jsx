...
const TextInput = ({text, placeholder, error, onUpdate}) => {
  return (
    <>
        <input type="text" placeholder={placeholder} className='w-full bg-white text-gray-800 px-6 p-3 border border-gray-950 text-sm focus:outline-none placeholder-gray-700'
